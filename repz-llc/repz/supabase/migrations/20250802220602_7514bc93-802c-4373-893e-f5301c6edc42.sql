...
-- 2. Create materialized view for analytics optimization
...
SELECT 
    ...
    date_part('day', MAX(dt.tracking_date) - MIN(dt.tracking_date)) as days_tracking
...
AS $$
BEGIN
    REFRESH MATERIALIZED VIEW CONCURRENTLY client_progress_summary;
END;
$$;
