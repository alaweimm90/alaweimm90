...
This section provides comprehensive API documentation for the ORCHEX-KILO integration, including TypeScript interfaces, classes, and integration points.
...
Represents events generated by the KILO governance system that trigger ORCHEX analysis.
...
This API reference provides comprehensive documentation for integrating with the ORCHEX-KILO bridge system. All interfaces and classes are fully typed and include detailed JSDoc comments for better IDE support and developer experience.
