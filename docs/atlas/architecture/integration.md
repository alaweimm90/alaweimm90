...
This section documents how ATLAS integrates with external systems and services.

---

## Overview

ATLAS is designed to integrate seamlessly with various development tools, platforms, and services. This document outlines the key integration points and patterns.

---

## KILO Integration

ATLAS integrates deeply with KILO for governance and DevOps automation. See [KILO Integration](../integration/kilo-integration.md) for complete details.
