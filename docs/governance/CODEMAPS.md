...
6. [ATLAS Workflow Orchestration](#6-atlas-workflow-orchestration)
...
│               └── MeatheadPhysicist, Turingo, ATLAS
```
...
## 6. ATLAS Workflow Orchestration

**Files:** `tools/atlas/orchestration/devops-agents.ts`, `tools/atlas/cli/commands/devops.ts`
...
│                    DEVOPS & ATLAS                                 │
│  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐   │
│  │ Template CLI    │  │ ATLAS Agents    │  │ Workflow Engine │   │
...
| **ATLAS Orchestration** | `tools/atlas/orchestration/devops-agents.ts`, `tools/atlas/cli/commands/devops.ts`                                                    |
