...
This section provides comprehensive API documentation for the ATLAS-KILO integration, including TypeScript interfaces, classes, and integration points.
...
Represents events generated by the KILO governance system that trigger ATLAS analysis.
...
Represents a code refactoring operation performed by ATLAS.
...
Interface for the KILO to ATLAS bridge implementation.
...
Interface for the ATLAS to KILO bridge implementation.
...
This API reference provides comprehensive documentation for integrating with the ATLAS-KILO bridge system. All interfaces and classes are fully typed and include detailed JSDoc comments for better IDE support and developer experience.
