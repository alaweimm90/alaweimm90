...
This directory contains tools and scripts to automate various aspects of the ATLAS-KILO integration migration process.
...
export ATLAS_CONFIG_PATH="./atlas.config.json"
...
- **Network Errors**: Connectivity issues with ATLAS or KILO services
