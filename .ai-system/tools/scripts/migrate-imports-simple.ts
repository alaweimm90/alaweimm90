...
const FILES_TO_MIGRATE = [
  'tools/cli/devops.ts',
  'tools/ORCHEX/cli/workflow-run.ts',
  'tools/ORCHEX/orchestration/workflows.ts',
  'tools/ORCHEX/cli/workflow-plan.ts',
  'tools/ORCHEX/orchestration/router.ts',
  'tools/ORCHEX/cli/utils.ts',
  'tools/ORCHEX/cli/commands.ts',
  'tools/ORCHEX/orchestration/index.ts',
  'tools/ORCHEX/orchestration/fallback.ts',
  'tools/ORCHEX/orchestration/executor.ts',
  'tools/ORCHEX/adapters/openai.ts',
  'tools/ORCHEX/adapters/google.ts',
  'tools/ORCHEX/adapters/anthropic.ts',
  'tools/ORCHEX/adapters/base.ts',
  'tools/ORCHEX/orchestration/devops-agents.ts',
  'tools/ORCHEX/api/router.ts',
  'tools/ai/cli/security-cli.ts',
  'tools/ai/cli/issues-cli.ts',
  'tools/ai/cli/compliance-cli.ts',
  'tools/ORCHEX/services/index.ts',
  'tools/ORCHEX/services/optimizer.ts',
  'tools/ORCHEX/services/monitor.ts',
  'tools/ORCHEX/refactoring/engine.ts',
  'tools/ORCHEX/services/dashboard.ts',
];
